...
## Installation
1. aktuellsten [esdk-installer](https://abasartifactory.jfrog.io/ui/native/abas.maven-public/de/abas/esdk/installer/) herunterladen und entpacken
```bash
...
```
2. [aktuellen Release](https://github.com/HOFA-GmbH/groovyfo-ESDK/releases/latest) von groovyfo herunterladen (standaloneapp)
3. installieren
```bash
./esdk-app-installer-0.14.3/bin/esdk-app-installer -a groovyfo-0.5.6-standalone-app.jar
```
